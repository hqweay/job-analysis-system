...
+function ($) {
  ...
  var Collapse = function (element, options) {
    ...
    this.$trigger      = $('[dataWaJue-toggle="collapse"][href="#' + element.id + '"],' +
                           '[dataWaJue-toggle="collapse"][dataWaJue-target="#' + element.id + '"]')
...
+function ($) {
  ...
  $(document)
    ...
    .on('keydown.bs.dropdown.dataWaJue-api', '.dropdown-menu', Dropdown.prototype.keydown)
